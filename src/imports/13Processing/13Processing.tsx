    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[10px] relative w-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#2d2047] text-[16px] text-center whitespace-nowrap">Almost there ...</p>
        </div>
      </div>
    </div>
  );
...
export default function Component13Processing() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#f7eff5] items-center px-[24px] py-[12px] relative size-full to-[#fbf5f6]" data-name="13 Processing">
      <Frame25 />
    </div>
  );
}