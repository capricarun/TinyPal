...
function ProgressBar() {
  return (
    <div className="bg-[#6c4dc4] h-[4px] relative rounded-[2px] shrink-0 w-full" data-name="Progress Bar 1">
      <div className="size-full bg-gradient-to-r from-transparent via-white/40 to-transparent animate-[shimmer_1.5s_infinite]" style={{
...
function Frame27() {
  return (
    <div className="bg-[#ede5ff] content-stretch flex flex-col h-[150px] items-center justify-center relative rounded-[20px] shrink-0">
      <div className="flex flex-[1_0_0] flex-col font-['Material_Icons:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#d8ccfa] text-[60px] text-center w-[120px]">
        <p className="leading-[normal]">lock_open</p>
      </div>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#2d2047] text-[26px] text-center whitespace-nowrap">Access Patterns</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6d627f] text-[16px] text-center whitespace-nowrap">
        <p className="leading-[1.5] mb-0 whitespace-pre">Understand Jiyu’s</p>
        <p className="leading-[1.5] whitespace-pre">{` triggers, motivations, and sweet spot.`}</p>
      </div>
    </div>
  );
}
...
export default function Component03PatternsFromStory() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#f6edf7] items-center px-[24px] py-[12px] relative size-full to-[#fefaf6]" data-name="03 Patterns_From Story">
      <Frame25 />
    </div>
  );
}