...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] inset-[12px_24px] items-start">
      <Frame15 />
      <Frame22 />
      <Frame13 />
    </div>
...
function Frame38() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[24px] items-center leading-[normal] not-italic relative shrink-0 text-black text-center w-full">
      <p className="relative shrink-0 text-[20px] w-full">{`Are you Sure you want to cancel? `}</p>
      <p className="relative shrink-0 text-[14px] w-full">You have unsaved changes, canceling will save them as a draft.</p>
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">No</p>
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="content-stretch flex h-[44px] items-center px-[24px] py-[12px] relative rounded-[36px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#b49ae8] border-solid inset-0 pointer-events-none rounded-[36px]" />
      <Frame40 />
    </div>
  );
...
function Frame46() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">Yes</p>
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="bg-[#6c4dc4] content-stretch flex h-[44px] items-center px-[24px] py-[12px] relative rounded-[36px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#b49ae8] border-solid inset-0 pointer-events-none rounded-[36px]" />
      <Frame44 />
    </div>
  );
...
function Frame36() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white content-stretch flex flex-col gap-[40px] items-center justify-center left-1/2 px-[24px] py-[40px] rounded-[16px] top-1/2 w-[382px]">
      <Frame38 />
      <Frame37 />
    </div>
  );
...
export default function Component09MomentEntry() {
  return (
    <div className="bg-gradient-to-b from-[#f6edf7] relative size-full to-[#fefaf6]" data-name="09 Moment Entry">
      <Frame14 />
      <div className="absolute bg-[rgba(0,0,0,0.35)] h-[932px] left-0 top-0 w-[430px]" />
      <Frame36 />
    </div>
  );
}