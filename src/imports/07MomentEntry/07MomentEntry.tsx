...
function Frame19() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] items-start justify-center min-h-px min-w-px relative rounded-[16px] w-full">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.8] min-h-px min-w-px not-italic relative text-[16px] text-[rgba(0,0,0,0.38)]">Jiyu didnt finish dinner, but seemed quieter than normal ...</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative rounded-[40px] shrink-0">
      <p className="font-['Material_Icons:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">mic</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">Record</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="bg-[#6c4dc4] relative rounded-[36px] self-stretch shrink-0">
...
function Frame21() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative rounded-[40px] shrink-0">
      <p className="font-['Material_Icons:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.84)] text-center whitespace-nowrap">close</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.84)] text-center whitespace-nowrap">Cancel</p>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="bg-[rgba(108,77,196,0.5)] h-full relative rounded-[36px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#b49ae8] border-solid inset-0 pointer-events-none rounded-[36px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex h-full items-center px-[16px] py-[12px] relative">
          <Frame31 />
...
export default function Component07MomentEntry() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#f6edf7] items-center px-[24px] py-[12px] relative size-full to-[#fefaf6]" data-name="07 Moment Entry">
      <Frame14 />
    </div>
  );
}