...
function Frame27() {
  return (
    <div className="bg-[#ede5ff] content-stretch flex flex-col h-[150px] items-center justify-center relative rounded-[20px] shrink-0">
      <div className="flex flex-[1_0_0] flex-col font-['Material_Icons:Regular',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#d8ccfa] text-[80px] text-center w-[120px]">
        <p className="leading-[normal]">pattern</p>
      </div>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#2d2047] text-[26px] text-center whitespace-nowrap">Pattern Emerge</p>
    </div>
  );
}
...
export default function Component02PatternsFromStory() {
  return (
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#f6edf7] items-center px-[24px] py-[12px] relative size-full to-[#fefaf6]" data-name="02 Patterns_From Story">
      <Frame25 />
    </div>
  );
}